...
let tests =
    ...
    testList "NumericFunctions"
        [ testList "Mods.Mod"
          ...
          testList "Mods.Add" [ testValueEqual (mods.Add Int32.MaxValue 1) 147483634 "over Int32" ]
          testList "Mods.Sub" [ testValueEqual (mods.Sub Int32.MinValue 1) 852516372 "under Int32" ]
          testList "Mods.Mul" [ testValueEqual (mods.Mul (1 <<< 17) (1 <<< 17)) 179869065 "over Int32" ]
          testList "Mods.Pow"
          ...
          testList "Mods.Div" [ testValueEqual (mods.Div 678813585 100000) 123456789 "div" ]
          testList "Mods.Perm"
